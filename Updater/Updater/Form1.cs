    ...
    public partial class Form1 : Form
    {
        ...
        void CheckForUpdates()
        {
            ...
            if (whatsthelatestversion.Contains(version))
            {
                ...
                updateLabel.Text = "The program is up to date";
                updatesButton.Text = "Check for updates";
            }
            else
            {
                bunifuGradientPanel1.GradientBottomLeft = System.Drawing.Color.Gold;
                bunifuGradientPanel1.GradientBottomRight = System.Drawing.Color.Yellow;
                updateLabel.Text = "There are some pending updates";
        ...
        private void StartDownload()
        {
            Thread thread = new Thread(() => {
                ...
                client.DownloadFileAsync(new Uri(downloadlink), "program.rar"); //you can change the file type if you want
            });
            thread.Start();
        }
        void client_DownloadProgressChanged(object sender, DownloadProgressChangedEventArgs e)
        {
            this.BeginInvoke((MethodInvoker)delegate {
                ...
                label2.Text = "Downloaded " + e.BytesReceived + " bytes of " + e.TotalBytesToReceive + " bytes";
        ...
        void client_DownloadFileCompleted(object sender, AsyncCompletedEventArgs e)
        {
            this.BeginInvoke((MethodInvoker)delegate {
                ...
                bunifuGradientPanel1.GradientBottomRight = System.Drawing.Color.Lime;
                updateLabel.Text = "The program is up to date";
                label2.Text = "The update has been downloaded on the program folder, please extract it.";
            });
        }
    }
}
